    ...
    computed: {
      ...
      columns() {
        const columns = [
          ...
          {
            title: '学段', key: 'role', align: 'center', ellipsis: true, minWidth: 150,
            render: (h, params) => showTip(h, params.row.stage)
          },
          {
            title: '年级', key: 'role', align: 'center', ellipsis: true, minWidth: 150,
            render: (h, params) => showTip(h, params.row.grade)
          },
          {
            title: '班级', key: 'role', align: 'center', ellipsis: true, minWidth: 150,
            render: (h, params) => showTip(h, params.row.class)
          },
          // {
          //   title: '创建时间', key: 'createTs', align: 'center', ellipsis: true, minWidth: 150,
